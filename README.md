...
npm run build:mac
```
*Note: Building for macOS typically requires running on a macOS machine.*
...
npm run build:win
```
*Note: You can build for Windows from macOS/Linux, but Wine may be required for some features.*
